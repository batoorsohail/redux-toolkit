...
# 📖 Redux Toolkit <a name="about-project"></a>

**Redux Toolkit** is a small project that made using React, Redux, JavaScript, HTML, and CSS. This is a project for practicing Redux. 
...
```sh
  cd my-folder
  git clone https://github.com/batoorsohail/redux-toolkit.git
```

### Install

To clone this repo go to "https://github.com/batoorsohail/redux-toolkit"
